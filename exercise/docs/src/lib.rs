...
//! most often deep yellow to orange in coloration. The thick shell contains the seeds and pulp.
//! The name is most commonly used for cultivars of Cucurbita pepo, but some cultivars of
...
pub struct Pumpkin {
    /// `roundness` is a percentage between 0 and 1.
    pub roundness: f32,
